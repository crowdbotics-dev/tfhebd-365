"""
Django settings for tfhebd_365 project.
...
WSGI_APPLICATION = 'tfhebd_365.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tfhebd_365 API",
    "DESCRIPTION": "API documentation for tfhebd_365 App",
    "VERSION": "v1",
}
